...
/**
 * Servlet implementation class InvestedChartView
 */
@WebServlet("/chart/invested")
public class InvestedChart extends HttpServlet {
	...
	protected void viewChart(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher header = request.getRequestDispatcher("/header?pos=investedchart");
		if (header != null) {
		...
		out.append("<li class=\"breadcrumb-item active\">Đầu tư</li>");
		out.append("</ol>");
		out.append("</nav>");
		out.append("</div><!-- End Page Title -->");

		out.append(this.viewProfitChart(months, invested));
		out.append("</main");
	...
	private StringBuilder viewProfitChart(StringBuilder months, StringBuilder invested) {
		StringBuilder tmp = new StringBuilder();
		tmp.append("<div class=\"card\">");
		tmp.append("<div class=\"card-body\">");
		tmp.append("<h5 class=\"card-title\">Biểu đồ thống kê đầu tư</h5>");
		tmp.append("");
